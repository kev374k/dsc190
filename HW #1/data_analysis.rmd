...
We also looked through the type of each variable, to see if we were mostly working with numerical, categorical, or a mix between the two. As seen below, all of the variables are of type 'int', meaning most are numerical, discrete variables. However, as we pointed out above, since 'smoke' and 'parity' were binary variables, these are nominal.
...
```{r, fig.width = 3, fig.height = 2.5, fig.ncol = 2, echo = FALSE}
...
```{r advanced-analysis, fig.width = 5, fig.height = 4, echo = FALSE}
